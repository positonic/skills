...
- **[close-shipped](./skills/engineering/close-shipped/SKILL.md)** — Sweep up after work that landed: remove the git worktrees whose branches merged, and promote Exponential Tickets from `QA` to `DONE` once their PR is confirmed merged. The manual stand-in for `/setup-merge-hook`.
